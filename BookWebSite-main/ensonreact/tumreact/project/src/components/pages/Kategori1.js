...
export default function Kategori1() {
  const [userIdf, setuserIdf] = useState(2)
  ...
  useEffect(() => {
    const kategori = new KitapService();

    kategori.getKitap(kategori)
      .then(response => {
        
        const booksList = response.data;
        
        setFavories(booksList);
      })
      .catch(error => {
...
<div className="w-3/4 m-auto">
    ...
    <main id ="main" > 
      ...
      {favories.map((kitap) => (
       <div key={kitap.kitapid} className="movie"> 
